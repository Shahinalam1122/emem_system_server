                ...
                <div class="col-lg-4 wow slideInUp" data-wow-delay="0.3s">
                    <div class="position-relative border border-primary rounded">
                        ...
                        <div class="text-center py-5">
                            <p class="border-bottom border-light mb-2 pb-2">CCTV</p>
                            <p class="border-bottom border-light mb-2 pb-2">It Solution</p>
                            <p class="border-bottom border-light mb-2 pb-2">PABX/INTERCOM</p>
                            <p class="border-bottom border-light mb-2 pb-2">VIDEO CONFERENCE</p>
                            <p class="mb-2 pb-2">BUSINESS COMMUNICATION</p>
                        </div>
                ...
                <div class="col-lg-4 wow slideInUp" data-wow-delay="0.6s">
                    <div class="position-relative border border-secondary rounded">
                        ...
                        <div class="text-center py-5">
                            ...
                            <p class="border-bottom border-light mb-2 pb-2">It Solution</p>
                            <p class="border-bottom border-light mb-2 pb-2">PABX/INTERCOM</p>
                            <p class="border-bottom border-light mb-2 pb-2">RUGGED LAPTOP</p>
                            <p class="mb-2 pb-2">SECURITY SYSTEMS</p>
                        </div>
                ...
                <div class="col-lg-4 wow slideInUp" data-wow-delay="0.9s">
                    <div class="position-relative border border-primary rounded">
                        ...
                        <div class="text-center py-5">
                            <p class="border-bottom border-light mb-2 pb-2">CCTV</p>
                            <p class="border-bottom border-light mb-2 pb-2">It Solution</p>
                            <p class="border-bottom border-light mb-2 pb-2">AUDIO VISUAL</p>
                            <p class="border-bottom border-light mb-2 pb-2">DOOR SECURITY</p>
                            <p class="mb-2 pb-2">NETWORKING EQUIPMENT</p>
                        </div>
                        <a href="" class="btn btn-primary py-2 px-4 position-absolute top-100 start-50 translate-middle">Order Now</a>
                    </div>
                </div>
