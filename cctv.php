...
<div class="container-fluid p-0 mb-5">
    <div id="header-carousel" class="carousel slide carousel-fade" data-bs-ride="carousel">
        ...
        <div class="carousel-inner">
            <div class="carousel-item active">
                <img class="w-100" src="img/tv1.jpg" alt="Image">
                <div class="carousel-caption d-flex flex-column align-items-center justify-content-center">
                    <div class="p-3" style="max-width: 900px; max-height: 400px;">
                        ...
                        <h1 class="display-1 text-white mb-md-4 animated zoomIn">CCTV Safety & Security For All</h1>
    ...
    <!-- cameras -->
    <?php
    include("site/pages/cctv-camera.php");
    ?>
    <!-- end cameras -->
