...
?>
    ...
    <!-- Business communication start -->
    <?php
        include("site/pages/business_communication.php");
    ?>
    <!-- Business communication end -->
   
    <!-- Business Communication Start -->
    <?php
        include("site/pages/business_communication_section.php");
    ?>
    <!-- Business Communication End -->
