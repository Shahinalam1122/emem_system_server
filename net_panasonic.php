            ...
            <div class="container1">
                ...
                <div class=" pabx-0 py-3">
                    <div class="mx-3 pabx-1">
                        <a href="panasonic_net_camra.html" class="btn btn-secondary py-md-3 px-md-5 animated slideInRight">Network Camera </a>
                    </div>
                        <div  class="me-3 pabx-1 ">
                            <a href="panasonic_net_int.html" class="btn btn-secondary py-md-3 px-md-5 animated slideInRight">Network intercoms</a>
    
                        </div>
                        <div class="mx-3 pabx-1">
                            <a href="panasonic_net_access_cont_.html" class="btn btn-secondary py-md-3 px-md-5 animated slideInRight">Access control</a>
                        </div>
